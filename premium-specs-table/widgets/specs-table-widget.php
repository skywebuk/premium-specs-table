...
class Premium_Specs_Table_Widget extends \Elementor\Widget_Base {

    public function get_name() {
        return 'premium_specs_table';
    }

    public function get_title() {
        return esc_html__('Premium Specs Table', 'premium-specs-table');
    }
    ...
    public function get_keywords() {
        return ['table', 'specs', 'specifications', 'pricing', 'features', 'premium'];
    }
    ...
    protected function register_controls() {
        ...
        $repeater->add_control(
            ...
            [
                ...
                'label_block' => true,
                'description' => esc_html__('Supports shortcodes. Use [your_shortcode] to display dynamic content.', 'premium-specs-table'),
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'highlight' => esc_html__('Highlighted (Gold)', 'premium-specs-table'),
        ...
        $this->add_control(
            ...
            [
                ...
                'description' => esc_html__('Enter a shortcode like [your_price_shortcode] to display dynamic pricing.', 'premium-specs-table'),
                'condition' => [
                    'show_price' => 'yes',
                ],
            ]
        ...
        $this->add_control(
            'table_background',
            [
                'label' => esc_html__('Background', 'premium-specs-table'),
                'type' => \Elementor\Controls_Manager::COLOR,
                'default' => '#141414',
                'selectors' => [
                    '{{WRAPPER}} .pst-table' => 'background: linear-gradient(145deg, {{VALUE}} 0%, #0d0d0d 100%);',
                ],
            ]
        );
        ...
        $this->add_control(
            'table_border_color',
            [
                'label' => esc_html__('Border Color', 'premium-specs-table'),
                'type' => \Elementor\Controls_Manager::COLOR,
                'default' => 'rgba(255, 255, 255, 0.06)',
                'selectors' => [
                    '{{WRAPPER}} .pst-table' => 'border-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .pst-table' => 'border-radius: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'table_padding',
            [
                'label' => esc_html__('Padding', 'premium-specs-table'),
                ...
                'selectors' => [
                    '{{WRAPPER}} .pst-table' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'table_shadow',
                'label' => esc_html__('Box Shadow', 'premium-specs-table'),
                'selector' => '{{WRAPPER}} .pst-table',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .pst-row' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .pst-row:not(:last-child)' => 'border-bottom-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Hover Background', 'premium-specs-table'),
                'type' => \Elementor\Controls_Manager::COLOR,
                'default' => 'rgba(212, 175, 55, 0.04)',
                'selectors' => [
                    '{{WRAPPER}} .pst-row:hover' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .pst-row' => 'border-radius: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'icon_color',
            [
                'label' => esc_html__('Icon Color', 'premium-specs-table'),
                'type' => \Elementor\Controls_Manager::COLOR,
                'default' => '#888888',
                'selectors' => [
                    '{{WRAPPER}} .pst-icon' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .pst-icon' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .pst-label' => 'gap: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'label_heading',
            [
                'label' => esc_html__('Labels', 'premium-specs-table'),
        ...
        $this->add_control(
            'value_heading',
            [
                'label' => esc_html__('Values', 'premium-specs-table'),
                'type' => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            'highlight_color',
            [
                'label' => esc_html__('Highlight Color (Gold)', 'premium-specs-table'),
                'type' => \Elementor\Controls_Manager::COLOR,
                'default' => '#d4af37',
                'selectors' => [
                    '{{WRAPPER}} .pst-value.pst-highlight' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .pst-badge' => 'color: {{VALUE}}; border-color: {{VALUE}}33;',
                    '{{WRAPPER}} .pst-price-value' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'badge_background',
            [
                'label' => esc_html__('Badge Background', 'premium-specs-table'),
                'type' => \Elementor\Controls_Manager::COLOR,
                'default' => 'rgba(212, 175, 55, 0.1)',
                'selectors' => [
                    '{{WRAPPER}} .pst-badge' => 'background: linear-gradient(135deg, {{VALUE}}, rgba(212, 175, 55, 0.05));',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .pst-badge' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .pst-badge' => 'border-radius: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'price_border_color',
            [
                'label' => esc_html__('Top Border Color', 'premium-specs-table'),
                'type' => \Elementor\Controls_Manager::COLOR,
                'default' => 'rgba(255, 255, 255, 0.04)',
                'selectors' => [
                    '{{WRAPPER}} .pst-price-row' => 'border-top-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__('Price Typography', 'premium-specs-table'),
                'selector' => '{{WRAPPER}} .pst-price-row',
            ]
        );
        ...
        $this->add_control(
            'price_value_size',
            [
                'label' => esc_html__('Price Value Size', 'premium-specs-table'),
                'type' => \Elementor\Controls_Manager::SLIDER,
                'size_units' => ['px', 'em'],
                'range' => [
                    'px' => [
                ...
                'selectors' => [
                    '{{WRAPPER}} .pst-price-value' => 'font-size: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
    ...
    private function get_all_icons() {
        return [
            ...
            'currency' => '<svg class="pst-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 7a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4c0 3 2 5 2 8H5"/><line x1="6" y1="21" x2="18" y2="21"/><line x1="5" y1="15" x2="15" y2="15"/><line x1="7" y1="15" x2="7" y2="21"/></svg>',
        ...
        <div class="pst-table">
            <?php foreach ($settings['table_rows'] as $index => $row) : ?>
                <?php if ($row['row_visible'] === 'yes') : ?>
                    <div class="pst-row">
                        ...
                        $value_class = 'pst-value';
                        
                        if ($row['value_style'] === 'highlight') {
                            $value_class .= ' pst-highlight';
                        } elseif ($row['value_style'] === 'badge') {
                            $value_class = 'pst-badge';
                        }
                        ?>
            ...
            <?php if ($settings['show_price'] === 'yes') : ?>
                <div class="pst-row pst-price-row">
                    <span class="pst-label"><?php echo esc_html($settings['price_label']); ?></span>
                    <span class="pst-value pst-price">
                        <?php echo esc_html($settings['price_prefix']); ?>
                        <span class="pst-price-value"><?php echo wp_kses_post(do_shortcode($settings['price_value'])); ?></span>
            ...
            <# _.each( settings.table_rows, function( row, index ) { #>
                <# if ( row.row_visible === 'yes' ) { #>
                    <div class="pst-row">
                        ...
                        if ( row.value_style === 'highlight' ) {
                            valueClass += ' pst-highlight';
                        } else if ( row.value_style === 'badge' ) {
                            valueClass = 'pst-badge';
                        }
                        #>
